...
![1536150032321](F:\python_jinjie\imgs\1536150032321.png)
...
RLock **可重入的锁**  在同一个线程里面，可以连续调用多次acquire， 一定要注意acquire的次数要和release的次数相等

#### 11.5 线程同步condition使用以及源码分析
